...
export class LibroListaComponent implements OnInit {
  ...
  libros: Libro[] = [];
  observableSubs: Subscription = new Subscription();
  observable: Observable<Libro[]> = new Observable<Libro[]>();
    ...
    this.observableSubs = this.libroObservableService.getLibros()
      .subscribe(
        ...
        // New:
        {
          ...
          complete: () => console.log("this.libroObservableService.getLibros() FINALIZADO")
        }
      );
  }
